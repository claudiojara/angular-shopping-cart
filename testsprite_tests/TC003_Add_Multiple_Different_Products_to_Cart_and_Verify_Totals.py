...
async def run_test():
    ...
    try:
        ...
        # -> Click 'Agregar al Carrito' for three different products (indexes 118, 151, 184) then open the Cart by clicking button index 78 to verify cart contents and totals.
        ...
        # -> Open the Cart view by clicking the cart button (index 78) to verify cart contents and total price.
        frame = context.pages[-1]
        # Click element
