...
export class ConfigService {
    ...
    try {
      ...
      const fallbackConfig: AppConfig = {
        ...
        supabase: {
          ...
          anonKey: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im93ZXd0emRkeXlreXJheGtrb3J4Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzAyNDE3MTcsImV4cCI6MjA4NTgxNzcxN30.E5M6cIwnJTt1Y04pApmvLNqpV5yQSOcNJHlCM_JDBRE'
        },
        environment: 'local',
        features: {
  ...
  getConfig(): AppConfig {
    ...
    if (!cfg) {
      throw new Error('Config not loaded. Call loadConfig() first or ensure APP_INITIALIZER is configured.');
    }
    return cfg;
  }
